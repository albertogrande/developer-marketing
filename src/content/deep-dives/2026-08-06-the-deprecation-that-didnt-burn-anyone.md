...
Two dates to watch. August 17: how Cerebras lands. End of September: whether any devtool that ships an MCP server publishes a dated public migration plan off the deprecated transport and auth — the test [the W31 weekly](/weekly/2026-W31) set. The first vendor to market its migration plan as a feature, rather than bury it as a chore, gets to own the positioning that this whole summer just made legible: *we end things well*.
