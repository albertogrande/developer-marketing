...
threads: [how-ai-features-get-priced, measuring-influence-not-attribution]
related:
...
[Last week](/issues/2026-W29) the agent-as-buyer thread graduated from Show HNs to platform roadmaps. This week the story was money — what AI features cost, and what buyers can prove they return. GitHub answered both halves within three days, and the answers belong together.
...
- **DevRelCon NYC wrapped July 23 — and three days later, no recaps.** The measurable-ROI hiring-bar claim from [last week's watch](/issues/2026-W29) remains single-sourced. It carries to W31; if recaps don't surface by mid-August, it was one person's job search.
