---
title: Ships an MCP server that lets Copilot, Claude Code and Cursor operate its cloud platform
company: Nutanix
date: 2026-08-13
kind: release
...
sources:
  - label: 'SD Times — Nutanix announces MCP server for Nutanix Cloud Platform'
    url: https://sdtimes.com/mcp-server/nutanix-announces-mcp-server-for-nutanix-cloud-platform
related:
